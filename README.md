...
| C10 | `47f943859b` (master) | [patch/c10-persist-key-fix.dsh.diff](patch/c10-persist-key-fix.dsh.diff) | **累积补丁(含 C1~C9,最新)**:真正的根因修复——本地持久化 key 从 `dsh.conversation.chat` 升到 `.v2`,丢弃旧结构坏数据,修复「硬刷新/重启仍不生效」 |
